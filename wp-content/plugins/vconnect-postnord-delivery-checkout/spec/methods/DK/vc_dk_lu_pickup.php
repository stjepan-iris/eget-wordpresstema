<?php
if (!class_exists('WC_VC_DK_LU_Pickup')) {

    class WC_VC_DK_LU_Pickup extends Vc_Aino_Shipping_Method {

        // Id for your shipping method. Should be uunique.
        public $vc_aino_id = 'vconnect_postnord_dk_lu_pickup';
        ...
        protected $vc_aino_title = 'LU pickup';
