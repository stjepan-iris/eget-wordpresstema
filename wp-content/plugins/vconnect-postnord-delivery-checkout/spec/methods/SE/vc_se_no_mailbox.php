<?php
if (!class_exists('WC_VC_SE_NO_Mailbox')) {

    class WC_VC_SE_NO_Mailbox extends Vc_Aino_Shipping_Method {

        // Id for your shipping method. Should be uunique.
        public $vc_aino_id = 'vconnect_postnord_se_no_mailbox';
        // Title shown in admin
        public $vc_aino_type = 'mailboxDelivery';
        // Title shown in admin
        protected $vc_aino_method_title = 'MyPack Home Small NO';
        ...
        protected $vc_aino_title = 'In mailbox / Maxi Letter - NO';
