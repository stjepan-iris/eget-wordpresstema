<?php
if (!class_exists('WC_VC_SE_DK_Mailbox')) {

    class WC_VC_SE_DK_Mailbox extends Vc_Aino_Shipping_Method {

        // Id for your shipping method. Should be uunique.
        public $vc_aino_id = 'vconnect_postnord_se_dk_mailbox';
        // Title shown in admin
        public $vc_aino_type = 'mailboxDelivery';
        // Title shown in admin
        protected $vc_aino_method_title = 'Varubrev DK';
        ...
        protected $vc_aino_title = 'In mailbox / Maxi Letter - DK';
