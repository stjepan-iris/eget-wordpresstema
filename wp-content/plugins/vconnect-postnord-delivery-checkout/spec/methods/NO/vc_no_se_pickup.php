<?php //
if (!class_exists('WC_VC_NO_SE_Pickup')) {

    class WC_VC_NO_SE_Pickup extends Vc_Aino_Shipping_Method {

        // Id for your shipping method. Should be uunique.
        public $vc_aino_id = 'vconnect_postnord_no_se_pickup';
        ...
        protected $vc_aino_title = 'Shipping Scandinavia - SE';
